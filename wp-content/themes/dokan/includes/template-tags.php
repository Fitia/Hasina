...
function dokan_content_nav( $nav_id, $query = null ) {
    ...
    <nav role="navigation" id="<?php echo $nav_id; ?>" class="<?php echo $nav_class; ?>">
        ...
        <?php if ( is_single() ) : // navigation links for single posts  ?>
            ...
            <li class="previous">
                <?php previous_post_link( '%link', _x( '←', 'Previous post link', 'dokan-theme' ) . ' %title' ); ?>
            </li>
            <li class="next">
                <?php next_post_link( '%link', '%title ' . _x( '→', 'Next post link', 'dokan-theme' ) ); ?>
            </li>
...
function dokan_page_navi( $before = '', $after = '', $wp_query ) {
    ...
    if ( $prevposts ) {
        ...
        echo '<li class="disabled"><a href="#">' . __( '← Previous', 'dokan-theme' ) . '</a></li>';
    }
    ...
    echo '<li class="">';
    next_posts_link( __('Next →', 'dokan-theme') );
    echo '</li>';
    if ( $end_page < $max_page ) {
        $last_page_text = "←";
